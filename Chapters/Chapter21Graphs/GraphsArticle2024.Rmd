...
of the graph. Figure \@ref(fig:Fig211Graph) illustrates the challenge
...
(ref:Fig211Graph) **Flow Chart of the Process of Communicating with a Graph.** The graph is a crucial intermediary in the process of communicating data interpretation to the receiver.
...
**Example 21.2.1: Including Zero To Compress Data**[^2]. Figure \@ref(fig:Fig212Graph) shows a time series of the
...
left-hand panel, Figure \@ref(fig:Fig212Graph)(a), provides the
...
the right-hand panel, Figure \@ref(fig:Fig212Graph)(b), uses the data
...
(ref:Fig212Graph) **Annual Insurance Employees, 1948-1993.** 'Insurance employees' is the percentage of full-time equivalent employees who are working for insurance carriers. Allowing the data to determine the scale ranges reveals interesting aspects of the data.
...
`r HideRCode('Fig212Graph.Hide',"R Code to Produce Figure 21.2")`
