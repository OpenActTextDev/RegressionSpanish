...
Figure \@ref(fig:Fig2.10). These are scatter plots of the
returns versus time, called *time series plots*. In Figure
\@ref(fig:Fig2.10), one can clearly see the smallest market
...
(ref:Fig2.10) **Time series plot of returns from the Lincoln National Corporation and the market.** There are 60 monthly returns over the period January, 1986 through December, 1990.
...
The scatter plot in Figure \@ref(fig:Fig2.11) graphically
...
\@ref(fig:Fig2.11) and represents a high leverage point. With
the regression line (described below) superimposed, the two outlying
points that can be seen in Figure \@ref(fig:Fig2.10) are also
evident. Despite these anomalies, the plot in Figure
\@ref(fig:Fig2.11) does suggest that there is a linear
relationship between Lincoln and market returns.


(ref:Fig2.11) **Scatterplot of Lincoln's return versus the S\&P 500 Index return.** The regression line is superimposed, enabling us to identify the market crash and two outliers.
...
in Figure \@ref(fig:Fig2.12). Fit a linear regression model of $LIFEEXP$ using the explanatory variable $x=FERTILITY$.


(ref:Fig2.12) **Plot of FERTILITY versus LIFEEXP.** 
