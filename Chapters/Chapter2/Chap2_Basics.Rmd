...
We begin by interpreting some of basic summary statistics, in Table \@ref(tab:SumStatsCAPM), in terms of financial theory. First, an
...
**Part 2:** Fit the model in Part 1.c(1) using 2001 data. Are
