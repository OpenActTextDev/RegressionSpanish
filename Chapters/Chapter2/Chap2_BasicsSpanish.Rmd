...
acotado entre -1 y 1, es decir, $-1\leq r\leq 1$. (El Ejercicio 2A.9
...
{\small error de predicción} & {\small =} & {\small error en la estimación
de la } &
{\small +} & {\small desviación de la observación adicional} \\
&  & {\small línea de regresión en *x*}$_{\ast}$ &  & {\small
respuesta de su media}
\end{tabular}
\end{center}
...
Para mostrar cuán influyente es este punto, reduce considerablemente el valor de $y$ y llama a este el nuevo punto C. Cuando se agrega este punto a los diecinueve puntos base, la situación empeora dramáticamente. El coeficiente $R^2$ baja del 89\% al 10\%, y el $s$ más que se triplica, de 0.29 a 0.87. Además, los coeficient

es de la línea de regresión cambian drásticamente.
