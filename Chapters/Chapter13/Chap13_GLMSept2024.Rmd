...
*  Bernoulli: $\mathbf{\mathrm{D}}(\widehat{\boldsymbol \pi})= 2\sum_i \left\{ y_i \ln \frac {y_i}{\widehat \pi_i} + (1-y_i) \ln \frac {1-y_i}{1-\widehat \pi_i}  \right\}$,  and
*  Poisson: $\mathbf{\mathrm{D}}(\widehat{\boldsymbol \mu})= 2\sum_i \left\{ y_i \ln \frac {y_i}{\widehat \mu_i} + (y_i - \widehat \mu _i) \right\}$.
...
For another alternative model specification, [Table 13.6](#Tab136) also shows a fit of an inverse gaussian
