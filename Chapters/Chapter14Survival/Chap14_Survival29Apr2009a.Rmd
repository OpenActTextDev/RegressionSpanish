...
\ref{S14:Cox} introduces the the *proportional hazards model*
...
## Censoring and Truncation {#S14:CensoringTruncation}
...
*  Type B. Complete information is available for a type B subject. The subject is
...
## Accelerated Failure Time Model {#S14:AFT}
...
A random variable $y$ is said to have a *log location-scale
...
## Proportional Hazards Model {#S14:Cox}
...
### Proportional Hazards {#S14:PHAssumption}
...
## Recurrent Events {#S14:RecurrentEvents}
...
**Example: Warranty Automobile Claims.**  Cook and Lawless (2007) consider a sample of 15,775 automobiles that were sold and under warranty for 365 days.
...
\\
\hline \multicolumn{7}{l}{{*Source(*}: Cook and Lawless (2007,
Table 1.3)}
\\
\end{tabular}
\scalefont{1.1111}
...
We present models of recurrent events using *counting
processes*, specifically employ *Poisson processes*. Although
...
## Further Reading and References} {#S14:Refer}
