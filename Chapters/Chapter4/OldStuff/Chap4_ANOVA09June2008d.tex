...
categorical variable introduced in Section \ref{S4:OneFactor},
$y_j=\mu_j + \varepsilon_j.$ In this model, there are $c$ levels of
the categorical variable. As in equation (\ref{E4:OneFactor}), this
...
the one Factor ANOVA table that appears in Section
\ref{S4:OneFactor}. As another example, we have that the standard
