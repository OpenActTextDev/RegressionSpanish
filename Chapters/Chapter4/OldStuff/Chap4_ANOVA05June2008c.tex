...
\textrm{EDUCATION} + 0.248 \textrm{NUMHH} \\
 & & ~~ +0.232 \textrm{MAR0} +0.789 \textrm{MAR2}.
\end{eqnarray*}
...
\end{eqnarray*}
The difference in these two equations is $0.789.$ We interpret the
regression coefficient associated with MAR2 to be the difference in
fitted values for someone living together compared to a similar
person who is married (the omitted category).

Similarly, we can interpret 0.232 to be the difference between the
...
Intercept & 2.605&  2.74 & 3.395 & 3.77 & 2.838 & 3.34\\

MAR0    &  0.232 &  0.44 & -0.557 & -2.15\\
