...
\textit{ANOVA} model, a special type of regression model that
permits easier analysis and interpretation.}
...
\linejed  \index{data!term life insurance}
...
\empexjed{AutoClaims} \index{data!automobile insurance claims}
...
\linejed \index{data!automobile insurance claims}
...
\empexjed{WiscHospCosts} \index{data!Wisconsin hospital costs}
...
\empexjed{HospitalCosts}\index{data!hospital costs}
...
\empexjed{WiscNursingHome}\index{data!nursing home utilization}
...
\empexjed{WiscLottery}\index{data!Wisconsin lottery sales}
...
\empexjed{NAICExpense}\index{data!insurance company expenses}
