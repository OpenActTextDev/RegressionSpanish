...
methods, Table \@ref{tab:T1:Galton} displays some data included in
...
Table \@ref{tab:T1:Galton} shows that much of the information concerning
...
Table \@ref{tab:T1:Galton} can also be used to study actuarial and other
...
```{r Fig11, fig.cap='(ref:Fig11)', out.width = '80%', fig.align = 'center', echo = FALSE}
...
Table \@ref{tab:T1:BISummaryStats} provides several statistics that
...
**Normal Curve Approximation.** Figure \@ref{F1:BIHist} also
...
entire distribution. For example, Table \@ref{tab:T1:BISummaryStats}
...
\begin{figure}[htp]
    \includegraphics[width=0.45\textwidth]
        {Chapters/Chapter1/F1BIHist.eps} \hfill  $~~~$
               \includegraphics[width=0.45\textwidth]
        {Chapters/Chapter1/F1BoxPlot.eps}
...
\begin{figure}[htp]
  \begin{center}
    \includegraphics[width=0.45\textwidth]
        {Chapters/Chapter1/F1BIHistRedraw.eps}
      \hfill
            \includegraphics[width=0.45\textwidth]
        {Chapters/Chapter1/F1BIQQPlot.eps}
...
known as \emph{skewed}. Figure \@ref{fig:F1:BIOrig} is an example of a
...
\begin{figure}[htp]
  \begin{center}
    \includegraphics[width=.4\textwidth]
        {Chapters/Chapter1/F1BIOrig.eps}
...
(ref:F1BIOrig) **Distribution of Bodily Injury Claims**. Observations are in (thousands of)
dollars with the largest observation omitted.


```{r F1:BIOrig, fig.cap='(ref:F1BIOrig)', out.width = '20%', fig.align = 'center', echo = FALSE}
knitr::include_graphics("C:/Users/jfrees/Dropbox/AAOnlineTextProject/Regression/Chapters/Chapter1/F1BIOrig.png")

```


```{r fig.cap='(ref:F1BIOrig)', out.width = '80%', fig.align = 'center', echo = FALSE, eval = FALSE}

eps_file <- "C:/Users/jfrees/Dropbox/AAOnlineTextProject/Regression/Chapters/Chapter1/F1Pareto.eps"
png_file <- "C:/Users/jfrees/Dropbox/AAOnlineTextProject/Regression/Chapters/Chapter1/F1Pareto.png"

# Use the postscript device to read the EPS file
temp <- postscript(eps_file)

# Set the device to output PNG
png(png_file)


# Add your plotting commands here if needed

# Close the devices
dev.off()  # Closes the postscript device
...
library(magick)
img <- image_read(temp)
img <- image_read("C:/Users/jfrees/Dropbox/AAOnlineTextProject/Regression/Chapters/Chapter1/F1BIOrig.eps")
image_write(img, "C:/Users/jfrees/Dropbox/AAOnlineTextProject/Regression/Chapters/Chapter1/F1BIOrig.png")
knitr::include_graphics("C:/Users/jfrees/Dropbox/AAOnlineTextProject/Regression/Chapters/Chapter1/F1BIOrig.png")
...
\begin{figure}[htp]
  \begin{center}
    \includegraphics[width=1\textwidth]
        {Chapters/Chapter1/F1Chisquare.eps}
